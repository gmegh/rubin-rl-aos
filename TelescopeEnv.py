...
class Telescope(Env):
    def __init__(self, name):
        ...
        # Define observation space to be the altitude and the reward
    ...
    def reset(self):
        ...
        # Define and reinitialize telescope
        '''
        self.closeLoopTask = CloseLoopTask()    
        args = argparse.Namespace(inst='comcam', filterType='ref', 
                        rotCam=0.0, m1m3FErr=0.05, 
    ...
    def step(self, action):
        ...
        return (self.altitude, -reward), -reward, done, []
